...
export const UpperHomePage = () => {
    ...
    return (
        <BlurFade delay={0.5} className="bg-background dark:bg-[#0a0a0a] relative flex h-[70vh] md:h-screen w-full flex-col gap-10 items-center justify-center overflow-hidden rounded-lg border">
